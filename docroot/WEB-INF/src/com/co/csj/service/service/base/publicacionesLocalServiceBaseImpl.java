...
/**
 * The base implementation of the publicaciones local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.co.csj.service.service.impl.publicacionesLocalServiceImpl}.
 * </p>
 *
 * @author Equipo
 ...
 * @generated
 */
public abstract class publicacionesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements publicacionesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.co.csj.service.service.publicacionesLocalServiceUtil} to access the publicaciones local service.
	 */
	...
	public publicaciones addpublicaciones(publicaciones publicaciones)
		throws SystemException {
		publicaciones.setNew(true);

		return publicacionesPersistence.update(publicaciones, false);
	}
	 ...
	 */
	public publicaciones createpublicaciones(long id) {
		return publicacionesPersistence.create(id);
	}
	...
	public publicaciones deletepublicaciones(long id)
		throws PortalException, SystemException {
		return publicacionesPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public publicaciones deletepublicaciones(publicaciones publicaciones)
		throws SystemException {
		return publicacionesPersistence.remove(publicaciones);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(publicaciones.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return publicacionesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return publicacionesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public publicaciones fetchpublicaciones(long id) throws SystemException {
		return publicacionesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public publicaciones getpublicaciones(long id)
		throws PortalException, SystemException {
		return publicacionesPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return publicacionesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<publicaciones> getpublicacioneses(int start, int end)
		throws SystemException {
		return publicacionesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getpublicacionesesCount() throws SystemException {
		return publicacionesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public publicaciones updatepublicaciones(publicaciones publicaciones)
		throws SystemException {
		return updatepublicaciones(publicaciones, true);
	}
	...
	public publicaciones updatepublicaciones(publicaciones publicaciones,
		...
		return publicacionesPersistence.update(publicaciones, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.co.csj.service.model.publicaciones",
			publicacionesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = publicacionesPersistence.getDataSource();
	...
	private publicacionesLocalServiceClpInvoker _clpInvoker = new publicacionesLocalServiceClpInvoker();
}