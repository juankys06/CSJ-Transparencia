...
<portlet:actionURL var="guardarArchivoFB" name="guardarArchivoFB"></portlet:actionURL>
...
<div class="container-fluid">
	...
	<div style="display: inline-block; vertical-align: top; width: 82%;">
		<form action="<%=guardarArchivoFB %>" method="post"  enctype="multipart/form-data">
			<div class="content-fliud">
				...
				<% if(!usuario.getArchivo_formulario_bienes().equals("")){
				%>
				<br>
				<div class="row">
					<div class="col-md-12">
						<div class="form-group text-center col-md-offset-2 col-md-8">
							<label for="archivoDR">ARCHIVO ACTUAL DE FORMULARIO DE BIENES</label>
							<portlet:resourceURL var="ver">
								<portlet:param name="pagina" value="formularioBienes"/>
								<portlet:param name="ruta" value="<%=usuario.getArchivo_formulario_bienes()%>"/>
							</portlet:resourceURL>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group text-center col-md-offset-2 col-md-8">
							<label for="archivoFB">SELECIONE SU ARCHIVO DE FORMULARIO DE BIENES EN FORMATO PDF</label>
							<input type="file" accept="application/pdf" class="anchoCompleto" style="max-width: 100% !important" id="archivoFB" name="archivoFB">
						</div>
					</div>
				</div>
				<% if(!usuario.getArchivo_formulario_bienes().equals("")){
...
<script>
$('#archivoFormuBienes').addClass("active");
