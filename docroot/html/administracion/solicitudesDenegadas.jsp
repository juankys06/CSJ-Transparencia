...
<%
	List<publicaciones> solicitudes = publicacionesLocalServiceUtil.getPorEstadoSolicitudes("NEGADA",0);
				...
				<div class="col-md-12">
					<liferay-ui:search-container   delta="10" deltaConfigurable="true"  emptyResultsMessage="No hay Solicitudes" iteratorURL="<%=iteratorURL%>">
							...
							<liferay-ui:search-container-row className="com.co.csj.service.model.publicaciones" keyProperty="id" modelVar="sol">
							    ...
							    <liferay-ui:search-container-column-text name="Fecha Negada" 		value="<%=formato.format(sol.getFecha_negado())  %>"/>	
							    <liferay-ui:search-container-column-text name="Causa" 		value="<%=sol.getCausa_negado()  %>"/>
							    <%
...
$('#solicitudesDenegadas').addClass("active");
</script>